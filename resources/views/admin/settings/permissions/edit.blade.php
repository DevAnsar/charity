            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate="" action="{{route('panel.permissions.update',['permission'=>$permission->id])}}" method="post">
                            @csrf
                            @method('patch')
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <div class="form-group position-relative">
                                        ...
                                        <input name="name" type="text"
                                               ...
                                               placeholder="" value="{{$permission->name}}" required="">
