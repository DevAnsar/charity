        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">اسلایدر اصلی</h4>
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card">
                    ...
                    @include('admin.contents.main_slider.navbar')
                            ...
                            <table id="datatable" class="table table-hover mb-0">
                                ...
                                @foreach($sliders as $key=>$slider)
                                    <tr>
                                        <th>{{$key+1}}</th>
                                        <th>
                                            <img style="width: 300px" src="{{env('IMG').$slider->image}}">
                                        </th>
                                        <th>
                                            <img style="width:150px" src="{{env('IMG').$slider->image_responsive}}">
                                        </th>
                                        <th>{{$slider->url}}</th>
                                        ...
                                        <th>
                                            @include('admin.contents.main_slider.actions',['id'=>$slider->id])
                                        </th>
                                    </tr>
                                @endforeach
                                </tbody>
