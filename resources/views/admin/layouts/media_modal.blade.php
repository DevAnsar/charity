        ...
        <div class="modal-content">
            <div class="modal-header align-items-stretch">
                ...
                <div style="width: 250px;" id="selectCollection" class="ml-auto mr-3">
                    <select name="collection_name" id="collection_name" class="form-control ">
                    </select>
                </div>

                <div id="resizeItems" class="ml-auto btn-group">
                    <button type="button" data-size="2" class="btn btn-outline-secondary"><i class="fa fa-th"></i>
                    </button>
                    <button type="button" data-size="3" class="btn btn-primary"><i class="fa fa-th-large"></i></button>
                    <button type="button" data-size="4" class="btn btn-outline-secondary"><i class="fa fa-square"></i>
                    </button>
                </div>
...
@push('scripts')
        ...
        <div class="col-sm-3">
            <div class="card clickble">
                ...
                <div class="card-footer">
                    <small>${name} (${formated_size})</small>
                    <br>
    ...
    <script type="text/javascript">
        ...
        function initSelectCollection() {
            ...
            $.ajax({
                url: "{!! url('/panel/uploads/collectionsNames') !!}",
                type: 'GET',
                success: function (data, status) {
                    console.log('collections', data);

                    const collections = Object.keys(data).map(i => data[i]);
        ...
        $('#mediaModal').on('show.bs.modal', function (event) {
            ...
            loadMedia("{!! url('/panel/uploads/all') !!}/" + dropzoneIndex);
            initSelectCollection();
        });

        $('#selectCollection #collection_name').on('change', function () {
            loadMedia("{!! url('/panel/uploads/all') !!}/" + $(this).val());
        })
    </script>
@endpush