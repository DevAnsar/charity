        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">دسته بندی وبلاگ</h4>
                        ...
                        <div class="">
                            <table id="datatable" class="table table-hover mb-0">
                                ...
                                @foreach($blogCategories as $key=>$blogCategory)
                                    <tr>
                                        <th>{{$key+1}}</th>
                                        <th>{{$blogCategory->title}}</th>

                                        <th>
                                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                                <a href="{{route('panel.blogCategories.index',['parent_id'=>$blogCategory->id])}}">
                                        ...
                                        <th>
                                            @if($blogCategory->status)
                                                <span class="badge-info badge">فعال</span>
                                            @else
                                                <span class="badge-warning badge">غیرفعال</span>
                                            @endif

                                        </th>
                                        <th>
                                            @include('admin.blog_categories.actions',['id'=>$blogCategory->id])
                                        </th>
                                    </tr>
                                @endforeach
                                </tbody>
